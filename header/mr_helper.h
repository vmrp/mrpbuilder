...
typedef int32 (*MR_C_FUNCTION)(mr_c_function_st* P, int32 code, uint8* input, int32 input_len, uint8** output, int32* output_len);
...
typedef struct _mrc_extChunk_st {
    ...
    /* 0x2c */ mr_table_st* extMrTable;  // mr_table函数表。
